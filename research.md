...
**Highlights:** Publications: 9 (5 IEEE & 4 other international journals)  · 42 citations worldwide  

## 📚 Selected Publications

1. *AI for Predictive Monitoring and Anomaly Detection in DevOps Environments.*  
   IEEE Xplore, 2025.  
   [Link](https://ieeexplore.ieee.org/abstract/document/10971552)

2. *AI-Driven Voice Inputs for Speech Engine Testing in Conversational Systems.*  
   IEEE Xplore, 2025.  
   [Link](https://ieeexplore.ieee.org/document/10971485)
...
5. *Advancing Robotics Testing: A Novel Framework for Adaptive and Scalable Evaluation.*  
   IEEE Xplore, 2024.  
   [Link](https://ieeexplore.ieee.org/abstract/document/10980524)

6. *Instrumentation for Robotics and Automation: Innovations, Challenges, and Future Directions.*  
   IEEE Xplore, 2024.  
