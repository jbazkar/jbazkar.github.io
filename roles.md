...
- **AI Framework Developer** – Created the AI-driven **SmartOps Framework** for Anomaly Detection, Predictive Monitoring, and Cost Optimization in DevOps/SRE environments.
  ...
  - **SmartOps Repository:** [SmartOps Git Repo](https://smartops.awsbaskar.net/smartops-repo)   
  - **BFSI Dashboard (Results Page):** [Framework Evidence Results](https://smartops.awsbaskar.net/bfsi_results.html)
- **🤖 AI Bot Creator** –created **SmartFactCheckBot_AIBot**, an AI-powered Fake/Real news detection bot enables instant news authenticity verification through Telegram or a simple, login-free web interface.
  ...
  - **Telegram Bot:** [@SmartFactCheck_AIBot](https://t.me/SmartFactCheck_AIBot)
  - **Web UI (No Login Required):** [FactCheck Web UI](https://factcheck.awsbaskar.net)
  - **GitHub Pages Repo:** [SmartFactCheck Git Repo](https://awsbaskar.net/smartfactcheckbot-repo)
